    ...
    <TooltipProvider>
      <main className="h-full flex flex-col p-4 md:p-6 bg-background text-foreground gap-4">
        <div className="flex flex-col md:flex-row h-full gap-4">
          ...
          {/* Left Column (Chart + New Bottom Card) */}
          <div className="w-full md:w-2/3 flex flex-col gap-4">
            {/* Main Chart Card */}
            <div className="flex-grow flex flex-col bg-card rounded-2xl shadow-lg p-4 gap-4">
              {/* Header Section */}
              ...
              {/* Chart Area */}
              <div className="flex-1 w-full relative rounded-lg overflow-hidden bg-background">
            ...
            {/* New Bottom Card */}
            <PlaceholderCard title="Analytics & News" className="h-48">
